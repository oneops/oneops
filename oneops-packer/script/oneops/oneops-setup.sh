...
gem install  $OO_HOME/dist/oneops-admin-inductor-1.0.0.gem --no-ri --no-rdoc
gem install  $OO_HOME/dist/oneops-admin-adapter-1.0.0.gem --no-ri --no-rdoc
gem install  $OO_HOME/dist/oneops-admin-inductor-az-1.0.0.gem --no-ri --no-rdoc
