...
public class WoExecutorTest {
  ...
  public void testExtraRunList4Wo() {
    ...
    String securityRecipe =
        AbstractOrderExecutor.RUN_LIST_PREFIX
            + "security"
            + AbstractOrderExecutor.RUN_LIST_SEPARATOR
            + "add"
            + AbstractOrderExecutor.RUN_LIST_SUFFIX;
    String dummyRecipe =
        AbstractOrderExecutor.RUN_LIST_PREFIX
            + "dummy"
            + AbstractOrderExecutor.RUN_LIST_SEPARATOR
  ...
  public void testCreateCookbookSearchPath() {
    ...
    LinkedHashSet<String> searchPaths =
        woExecutor.createCookbookSearchPath("circuit-main-1", cloudServices, cloudName);
  ...
  public void testOrgLevelWhenOrgMatchCloudExactMatch() {
    Map<String, Object> servicesMap =
        commonCloudConfigurationsHelper.findServicesAtOrgLevel(cloudConfig, "org", "cloud-exact");
    Map<String, Object> classesMap =
        commonCloudConfigurationsHelper.findServiceClasses(servicesMap, "service");
    Map<String, Object> ciAttributes =
        commonCloudConfigurationsHelper.findClassCiAttributes(classesMap, "classname");
  ...
  public void testOrgLevelWhenOrgMatchCloudRegexMatch() {
    Map<String, Object> servicesMap =
        commonCloudConfigurationsHelper.findServicesAtOrgLevel(
            cloudConfig, "org", "cloud-regex123");
    Map<String, Object> classesMap =
        commonCloudConfigurationsHelper.findServiceClasses(servicesMap, "service");
    Map<String, Object> ciAttributes =
        commonCloudConfigurationsHelper.findClassCiAttributes(classesMap, "classname");
  ...
  public void testCloudLevelWhenCloudExactMatch() {
    Map<String, Object> servicesMap =
        commonCloudConfigurationsHelper.findServicesAtCloudLevel(cloudConfig, "cloud-exact");
    Map<String, Object> classesMap =
        commonCloudConfigurationsHelper.findServiceClasses(servicesMap, "service");
    Map<String, Object> ciAttributes =
        commonCloudConfigurationsHelper.findClassCiAttributes(classesMap, "classname");
  ...
  public void testCloudLevelWhenCloudRegexMatch() {
    Map<String, Object> servicesMap =
        commonCloudConfigurationsHelper.findServicesAtCloudLevel(cloudConfig, "cloud-regex123");
    Map<String, Object> classesMap =
        commonCloudConfigurationsHelper.findServiceClasses(servicesMap, "service");
    Map<String, Object> ciAttributes =
        commonCloudConfigurationsHelper.findClassCiAttributes(classesMap, "classname");
  ...
  public void testServicesLevelWhenServiceMatchAndAttrMatch() {
    Map<String, Object> classesMap =
        commonCloudConfigurationsHelper.findServiceClasses(cloudConfig, "service");
    Map<String, Object> ciAttributes =
        commonCloudConfigurationsHelper.findClassCiAttributes(classesMap, "classname");
