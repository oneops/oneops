...
public class CmAddCiAttribute extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1758740143;

    /**
     * The parameter <code>kloopzcm.cm_add_ci_attribute.p_ci_id</code>.
     */
    public static final Parameter<Long> P_CI_ID = createParameter("p_ci_id", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>kloopzcm.cm_add_ci_attribute.p_attribute_id</code>.
     */
    ...
    public CmAddCiAttribute() {
        ...
        addOutParameter(OUT_CI_ATTR_ID);
    }
    ...
    /**
     * Get the <code>out_ci_attr_id</code> parameter OUT value from the routine
     */
    public Long getOutCiAttrId() {
        return get(OUT_CI_ATTR_ID);
    }
}
