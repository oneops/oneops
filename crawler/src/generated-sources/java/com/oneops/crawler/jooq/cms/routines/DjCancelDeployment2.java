...
public class DjCancelDeployment2 extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1554794057;

    /**
     * The parameter <code>kloopzcm.dj_cancel_deployment.p_deployment_id</code>.
     */
    ...
    /**
     * The parameter <code>kloopzcm.dj_cancel_deployment.p_updated_by</code>.
     */
    ...
    /**
     * The parameter <code>kloopzcm.dj_cancel_deployment.p_desc</code>.
     */
    public static final Parameter<String> P_DESC = createParameter("p_desc", org.jooq.impl.SQLDataType.VARCHAR, false, false);

    /**
     * The parameter <code>kloopzcm.dj_cancel_deployment.p_comments</code>.
     */
     ...
     */
    public DjCancelDeployment2() {
        super("dj_cancel_deployment", Kloopzcm.KLOOPZCM);
