...
public class DjResetFailedRecords extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1387239283;

    /**
     * The parameter <code>kloopzcm.dj_reset_failed_records.p_deployment_id</code>.
     */
     ...
     */
    public DjResetFailedRecords() {
        super("dj_reset_failed_records", Kloopzcm.KLOOPZCM);
