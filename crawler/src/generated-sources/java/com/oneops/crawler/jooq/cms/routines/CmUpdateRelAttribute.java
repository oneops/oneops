...
public class CmUpdateRelAttribute extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1407840459;

    /**
     * The parameter <code>kloopzcm.cm_update_rel_attribute.p_ci_rel_attr_id</code>.
     */
    public static final Parameter<Long> P_CI_REL_ATTR_ID = createParameter("p_ci_rel_attr_id", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>kloopzcm.cm_update_rel_attribute.p_df_value</code>.
     */
    public static final Parameter<String> P_DF_VALUE = createParameter("p_df_value", org.jooq.impl.SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>kloopzcm.cm_update_rel_attribute.p_dj_value</code>.
     */
    public static final Parameter<String> P_DJ_VALUE = createParameter("p_dj_value", org.jooq.impl.SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>kloopzcm.cm_update_rel_attribute.p_owner</code>.
     */
    public static final Parameter<String> P_OWNER = createParameter("p_owner", org.jooq.impl.SQLDataType.VARCHAR, false, false);

    /**
     * The parameter <code>kloopzcm.cm_update_rel_attribute.p_comments</code>.
     */
     ...
     */
    public CmUpdateRelAttribute() {
        super("cm_update_rel_attribute", Kloopzcm.KLOOPZCM);

        addInParameter(P_CI_REL_ATTR_ID);
    ...
    /**
     * Set the <code>p_ci_rel_attr_id</code> parameter IN value to the routine
     */
    public void setPCiRelAttrId(Long value) {
        setValue(P_CI_REL_ATTR_ID, value);
    }
