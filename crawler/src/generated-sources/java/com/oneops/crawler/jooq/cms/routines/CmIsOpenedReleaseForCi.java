...
public class CmIsOpenedReleaseForCi extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -779992564;

    /**
     * The parameter <code>kloopzcm.cm_is_opened_release_for_ci.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>kloopzcm.cm_is_opened_release_for_ci.p_ci_id</code>.
     */
     ...
     */
    public CmIsOpenedReleaseForCi() {
        super("cm_is_opened_release_for_ci", Kloopzcm.KLOOPZCM, org.jooq.impl.SQLDataType.BOOLEAN);
