...
public class MdCreateRelation extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1824653389;

    /**
     * The parameter <code>kloopzcm.md_create_relation.p_rel_id</code>.
     */
    public static final Parameter<Integer> P_REL_ID = createParameter("p_rel_id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>kloopzcm.md_create_relation.p_rel_name</code>.
     */
    public static final Parameter<String> P_REL_NAME = createParameter("p_rel_name", org.jooq.impl.SQLDataType.VARCHAR, false, false);

    /**
     * The parameter <code>kloopzcm.md_create_relation.p_short_rel_name</code>.
     */
    ...
    /**
     * The parameter <code>kloopzcm.md_create_relation.p_descr</code>.
     */
     ...
     */
    public MdCreateRelation() {
        super("md_create_relation", Kloopzcm.KLOOPZCM);
