 ...
 *         clients:
 *         write: PerfSink uses process() and constructor or property setters for cassandra connection
 *         read: web.PerfAndLogController uses getPerfData() getLogData() ; getPerfAvailable() getLogAvailable()
 */
@Component
