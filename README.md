...
Component that processes ops events(unhealthy, notify) and decide what to do with them. 

## Usage

Used internally for consuming events which can  trigger a notification , scale-up /scale-down, replace or auto-repair. 
...
* git clone https://github.com/oneops/opamp.git
* cd opamp
* mvn clean package 
