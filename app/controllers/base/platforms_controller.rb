class Base::PlatformsController < ApplicationController
  ...
  def diagram
    ...
    depends_rels = Cms::DjRelation.all(:params => {:nsPath            => @environment ? transition_platform_ns_path(@environment, @platform) : design_platform_ns_path(@assembly || @catalog, @platform),
