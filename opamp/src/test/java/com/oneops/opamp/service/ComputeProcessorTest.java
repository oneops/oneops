...
public class ComputeProcessorTest {
	...
	public void ComputeProcessorTest_replaceComputeByCid_computeRelacedSuccessFully() {
		...
		assertEquals(result.get("deploymentId"), Integer.valueOf(0),
				"Deployment must have succeeded with response code: 0 , result.entrySet(): " + result.entrySet());
	...
	public void ComputeProcessorTest_replaceComputeByCid_computeCannotBeRelaced() {
		...
		assertEquals(result.get("deploymentId"), Integer.valueOf(1),
				"Deployment must have failed with response code: 1 , result.entrySet(): " + result.entrySet());
