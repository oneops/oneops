...
public interface OpsMapper {
  ...
  void updateCmsOpsProcedureState(@Param("procedureId") long procedureId,
      @Param("state") OpsProcedureState state);

  void updateCmsOpsActionState(@Param("actionId") long actionId,
      @Param("state") OpsActionState state);
  ...
  List<CmsOpsAction> getCmsOpsActionsForCi(@Param("procedureId") long procedureId,
      @Param("ciId") long ciId);

  List<CmsOpsProcedure> getProcedureForCi(@Param("ciId") long ciId,
      @Param("stateList") List<OpsProcedureState> stateList, @Param("name") String procedureName,
      @Param("limit") Integer limit);

  List<CmsOpsProcedure> getProcedureForCiByAction(@Param("ciId") long ciId,
      @Param("stateList") List<OpsProcedureState> stateList, @Param("name") String procedureName,
      @Param("limit") Integer limit);

  List<CmsOpsProcedure> getProcedureForNamespace(@Param("nspath") String nsPath,
      @Param("stateList") List<OpsProcedureState> stateList, @Param("name") String procedureName);
   ...
   */
  List<CmsOpsProcedure> getProcedureForNamespaceLike(@Param("ns") String ns,
      @Param("nsLike") String nsLike, @Param("stateList") List<OpsProcedureState> stateList,
      @Param("name") String procedureName, @Param("limit") Integer limit);

  List<CmsActionOrder> getActionOrders(@Param("procedureId") long procedureId,
      @Param("state") OpsProcedureState state, @Param("execOrder") Integer execOrder);
