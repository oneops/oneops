...
public class EmailService implements NotificationSender{
	...
	/* (non-Javadoc)
	 * @see com.oneops.antenna.senders.NotificationSender#postMessage(com.oneops.antenna.domain.NotificationMessage, com.oneops.antenna.domain.BasicSubscriber)
	 */
	@Override
	/** posts the message
	 * which must be be given a Subscriber of type EmailSubscriber
	 */
