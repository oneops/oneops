...
public class CmsUtilTest {
	...
	public CmsUtilTest() {
		//TODO common setup code for everyone!
...
//TODO	@Test
	...
	public void processAllVarsTest(){
		...
		CmsCI ci = new CmsCI();
		ci.setCiId(4444);ci.setCiName("processAllVarsTest");
		...
		dumpMaps(cloudVars,globalVars,localVars); dumpCmsCIAttributes(ci);
	...
	public void processGlobalValueWithCloudValueResolution(){
		...
		CmsCI ci = new CmsCI();
		ci.setCiId(9876);ci.setCiName("processGlobalValueWithCloudValueResolution");
		Map<String, CmsCIAttribute> attributes = new LinkedHashMap<String, CmsCIAttribute>(cloudValues.length * 3);
		///set up the ci with attributes which each need replacing...
		int i = 0;
		for (String cloudVariable : cloudValues){//3 cloud vars
		...
		CmsUtil util = new CmsUtil();
                dumpMaps(cloudVars,globalVars,null); dumpCmsCIAttributes(ci);
	...
	public void processLocalValueWithGlobalValueResolution(){
		...
		CmsCI ci = new CmsCI();
		ci.setCiId(135791113);ci.setCiName("processLocalValueWithGlobalValueResolution");
		...
		CmsUtil util = new CmsUtil();
                dumpMaps(null,globalVars,localVars); dumpCmsCIAttributes(ci);
	...
	public void processLocalValueWithGlobalAndCloudValueResolution(){
		...
		CmsCI ci = new CmsCI();
		ci.setCiId(89);ci.setCiName("processLocalValueWithGlobalAndCloudValueResolution");
		Map<String, CmsCIAttribute> attributes = new LinkedHashMap<String, CmsCIAttribute>(2);
		CmsCIAttribute attrL = new CmsCIAttribute();
	...
	public void processLocalVarChoiceGlobalVsCloud(){
		...
		CmsCI ci = new CmsCI();
		ci.setCiId(90);ci.setCiName("processLocalVarChoiceGlobalVsCloud");
		Map<String, CmsCIAttribute> attributes = new LinkedHashMap<String, CmsCIAttribute>(2);
		int i = 0;
		CmsCIAttribute attrL = new CmsCIAttribute();
	...
	public void processLocalVarMid(){
		...
		CmsCI ci = new CmsCI();
		ci.setCiId(95);ci.setCiName("processLocalVarMid");
		Map<String, CmsCIAttribute> attributes = new LinkedHashMap<String, CmsCIAttribute>(2);
		int i = 0;
		CmsCIAttribute attrL = new CmsCIAttribute();
		...
		CmsUtil util = new CmsUtil();
                dumpMaps(null,null,localVars); dumpCmsCIAttributes(ci);
	...
	public void processLocalVarDuo(){
		...
		CmsCI ci = new CmsCI();
		ci.setCiId(98);ci.setCiName("processLocalVarDuo");
		Map<String, CmsCIAttribute> attributes = new LinkedHashMap<String, CmsCIAttribute>(2);
		int i = 0;
		CmsCIAttribute attrL = new CmsCIAttribute();
	...
	public void processLocalVarMixed(){
		...
		CmsCI ci = new CmsCI();
		ci.setCiId(111);ci.setCiName("processLocalVarMixed");
		Map<String, CmsCIAttribute> attributes = new LinkedHashMap<String, CmsCIAttribute>(2);
		CmsCIAttribute attrL = new CmsCIAttribute();
	...
	public void processLocalVarTrips(){
		...
		CmsCI ci = new CmsCI();
		ci.setCiId(115);ci.setCiName("processLocalVarTrips");
		Map<String, CmsCIAttribute> attributes = new LinkedHashMap<String, CmsCIAttribute>(2);
		CmsCIAttribute attrL = new CmsCIAttribute();
	...
	public void processLocalVarNegativeSpelling(){
		...
		CmsCI ci = new CmsCI();
		ci.setCiId(122);ci.setCiName("processLocalVarNegativeSpelling");
	...
	public void processLocalVarNegativeMissingLocal(){
		...
		CmsCI ci = new CmsCI();
		ci.setCiId(130);ci.setCiName("processLocalVarNegativeMissingLocal");
		Map<String, CmsCIAttribute> attributes = new LinkedHashMap<String, CmsCIAttribute>(1);
		CmsCIAttribute attrL = new CmsCIAttribute();
	...
	public void processLocalVarNegativeMissingLocal2(){
		CmsCI ci = new CmsCI();
		ci.setCiId(132);ci.setCiName("processLocalVarNegativeMissingLocal2");
		Map<String, CmsCIAttribute> attributes = new LinkedHashMap<String, CmsCIAttribute>(1);
		CmsCIAttribute attrL = new CmsCIAttribute();
		attrL.setDjValue("$OO_LOCAL{this-is-not-resolved}");
		String nameOfAttribute = "trouble";
		...
		CmsUtil util = new CmsUtil();
                dumpMaps(null,null,null); dumpCmsCIAttributes(ci);
	...
	public void processLocalVarNegativeMissingGlobal(){
		CmsCI ci = new CmsCI();
		ci.setCiId(132);ci.setCiName("processLocalVarNegativeMissingGlobal");
		Map<String, CmsCIAttribute> attributes = new LinkedHashMap<String, CmsCIAttribute>(1);
		CmsCIAttribute attrL = new CmsCIAttribute();
	...
	public void processLocalVarNegativeMissingGlobal2(){
		...
		CmsCI ci = new CmsCI();
		ci.setCiId(132);ci.setCiName("processLocalVarNegativeMissingGlobal2");
		Map<String, CmsCIAttribute> attributes = new LinkedHashMap<String, CmsCIAttribute>(1);
		CmsCIAttribute attrL = new CmsCIAttribute();
		...
		CmsUtil util = new CmsUtil();
                dumpMaps(null,globalVars,null); dumpCmsCIAttributes(ci);
	...
	public void processLocalVarNegativeMissingCloud1(){
		...
		CmsCI ci = new CmsCI();
		ci.setCiId(133);ci.setCiName("processLocalVarNegativeMissingCloud1");
		Map<String, CmsCIAttribute> attributes = new LinkedHashMap<String, CmsCIAttribute>(1);
		CmsCIAttribute attrL = new CmsCIAttribute();
		...
		CmsUtil util = new CmsUtil();
                dumpMaps(cloudVars,null,null); dumpCmsCIAttributes(ci);
	...
	public void processLocalVarNegativeMissingCloud(){
		CmsCI ci = new CmsCI();
		ci.setCiId(134);ci.setCiName("processLocalVarNegativeMissingCloud");
		Map<String, CmsCIAttribute> attributes = new LinkedHashMap<String, CmsCIAttribute>(1);
		CmsCIAttribute attrL = new CmsCIAttribute();
		attrL.setDjValue("$OO_CLOUD{not-cloudy}");
		String nameOfAttribute = "sun";
	...
	public void processLocalVarDemo(){
		...
		CmsCI ci = new CmsCI();
		ci.setCiId(140);ci.setCiName("processLocalVarDemo");
		Map<String, CmsCIAttribute> attributes = new LinkedHashMap<String, CmsCIAttribute>(2);
		CmsCIAttribute attrL = new CmsCIAttribute();
	...
	public void processLocalVarBlankValue(){
		...
		cloudVars.put("FOO","" ) ;
		CmsCI ci = new CmsCI();
		ci.setCiId(150);ci.setCiName("processLocalVarBlankValue");
		Map<String, CmsCIAttribute> attributes = new LinkedHashMap<String, CmsCIAttribute>(1);
		CmsCIAttribute attrL = new CmsCIAttribute();
